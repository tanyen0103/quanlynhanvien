...
<html lang="en">
	<head>
		...
		<title>Sửa thông báo - Quản lý nhân viên</title>
	</head>
	<body>
		<div class="container">
			<!-- Menu: sử dụng navbar -->
			...
			<div class="card mt-3">
				...
				<div class="card-body">
					<form action="thongbao_sua_xuly.php" method="post" class="needs-validation" novalidate>
		...
		<script type="module">
			...
			const docRef = doc(db, 'thongbao', '<?php echo $_GET['id']; ?>');
